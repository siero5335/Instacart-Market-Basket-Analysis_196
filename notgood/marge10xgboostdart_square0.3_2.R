...
prd <- orders_products %>%
  ...
  summarise(
    ...
    prod_days_since_prior_order10 = sum(days_since_prior_order < 10, na.rm = T),
    prod_days_since_prior_order30 = sum(days_since_prior_order > 10 & days_since_prior_order < 30, na.rm = T),
