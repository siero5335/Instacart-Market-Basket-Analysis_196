...
users$user_diff_ordersd <-  users$user_sd_days_since_prior / (users$user_diff_ordermean + 1)
...
write.csv(submission, file = "bf_xgboost_0.21_sq0.3_out1.csv", row.names = F)
