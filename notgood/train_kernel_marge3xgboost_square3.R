...
#model4
set.seed(123)
subtrain4 <- train %>% sample_frac(0.1)
...
#model5
set.seed(24)
subtrain5 <- train %>% sample_frac(0.1)
...
#model6
set.seed(35)
subtrain6 <- train %>% sample_frac(0.1)
...
#model7
set.seed(57)
subtrain7 <- train %>% sample_frac(0.1)
...
#model8
set.seed(65)
subtrain8 <- train %>% sample_frac(0.1)
...
#model9
set.seed(92)
subtrain9 <- train %>% sample_frac(0.1)
...
write.csv(submission, file = "submit_kernel_marge3xgboost_0.21_sq4.csv", row.names = F)