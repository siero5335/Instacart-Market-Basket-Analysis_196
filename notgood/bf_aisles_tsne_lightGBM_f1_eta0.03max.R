...
set.seed(71)
test1 <- Rtsne(as.matrix(prd[, -c(1, 6:21,26:29, 39)]), dims = 2, initial_dims = 50, perplexity = 30,
...
set.seed(71)
test1 <- Rtsne(as.matrix(users[, -c(2, 24, 30, 32)]), dims = 2, initial_dims = 30, perplexity = 30,
...
product_period <- fread("product_period.csv")
product_period$V1 <- NULL
...
set.seed(71)
model1_4 <- lgb.train(data = X1, valids = list(eval = evalX1), params = params, 
                      nrounds = 5000, early_stopping_rounds=30)
...
set.seed(71)
model1_5 <- lgb.train(data = X1, valids = list(eval = evalX1), params = params, 
                      nrounds = 5000, early_stopping_rounds=30)
...
set.seed(71)
model1_6 <- lgb.train(data = X1, valids = list(eval = evalX1), params = params, 
                      nrounds = 5000, early_stopping_rounds=30)
...
out1_2 <- predict(model1_2, 
                  data = data.matrix(test %>% select(-order_id, -product_id)), 
                  n = model1_1$best_iter)
out1_3 <- predict(model1_2, 
                  data = data.matrix(test %>% select(-order_id, -product_id)), 
                  n = model1_1$best_iter)
out1_4 <- predict(model1_2, 
                  data = data.matrix(test %>% select(-order_id, -product_id)), 
                  n = model1_1$best_iter)
out1_5 <- predict(model1_2, 
                  data = data.matrix(test %>% select(-order_id, -product_id)), 
                  n = model1_1$best_iter)
out1_6 <- predict(model1_2, 
                  data = data.matrix(test %>% select(-order_id, -product_id)), 
                  n = model1_1$best_iter)

test$reordered <- (out1_1 + out1_2 + out1_3 + out1_4 + out1_5 + out1_6)/5
