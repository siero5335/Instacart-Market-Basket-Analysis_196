...
#model1
set.seed(71)
subtrain1 <- train %>% sample_frac(0.4)
...
#model2
set.seed(57)
subtrain2 <- train %>% sample_frac(0.4)
...
#model3
set.seed(42)
subtrain3 <- train %>% sample_frac(0.4)
...
#model4
set.seed(123)
subtrain4 <- train %>% sample_frac(0.4)
...
#model5
set.seed(24)
subtrain5 <- train %>% sample_frac(0.4)
...
#model6
set.seed(35)
subtrain6 <- train %>% sample_frac(0.4)
...
#model7
set.seed(57)
subtrain7 <- train %>% sample_frac(0.4)
...
#model8
set.seed(65)
subtrain8 <- train %>% sample_frac(0.4)
...
#model9
set.seed(92)
subtrain9 <- train %>% sample_frac(0.4)
...
write.csv(submission, file = "submit_kernel_marge10xgboost_0.21_sq0.4.csv", row.names = F)