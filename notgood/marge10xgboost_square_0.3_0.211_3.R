...
cv.nround <- 10000 #search
set.seed(71)
bst.cv <- xgb.cv(params = params, data = X2, nfold = 4, nrounds=cv.nround, early_stopping_rounds=3)
nround <- bst.cv$best_iteration
...
cv.nround <- 10000 #search
set.seed(71)
bst.cv <- xgb.cv(params = params, data = X3, nfold = 4, nrounds=cv.nround, early_stopping_rounds=3)
nround <- bst.cv$best_iteration
...
cv.nround <- 10000 #search
set.seed(71)
bst.cv <- xgb.cv(params = params, data = X4, nfold = 4, nrounds=cv.nround, early_stopping_rounds=3)
nround <- bst.cv$best_iteration
...
cv.nround <- 10000 #search
set.seed(71)
bst.cv <- xgb.cv(params = params, data = X5, nfold = 4, nrounds=cv.nround, early_stopping_rounds=3)
nround <- bst.cv$best_iteration
...
cv.nround <- 10000 #search
set.seed(71)
bst.cv <- xgb.cv(params = params, data = X6, nfold = 4, nrounds=cv.nround, early_stopping_rounds=3)
nround <- bst.cv$best_iteration
...
cv.nround <- 10000 #search
set.seed(71)
bst.cv <- xgb.cv(params = params, data = X7, nfold = 4, nrounds=cv.nround, early_stopping_rounds=3)
nround <- bst.cv$best_iteration
...
cv.nround <- 10000 #search
set.seed(71)
bst.cv <- xgb.cv(params = params, data = X8, nfold = 4, nrounds=cv.nround, early_stopping_rounds=3)
nround <- bst.cv$best_iteration
...
cv.nround <- 10000 #search
set.seed(71)
bst.cv <- xgb.cv(params = params, data = X9, nfold = 4, nrounds=cv.nround, early_stopping_rounds=3)
nround <- bst.cv$best_iteration
...
write.csv(submission, file = "xgboost_0.21_sq0.3_eta0.05.csv", row.names = F)