...
predFM = cv_libFM(reordered ~ ., data = train,
               task = "c", dims = seq(0, 20, by = 5), iter = 500, 
               exe_loc = "/Users/siero5335/libfm-1.42.src/bin")
...
write.csv(submission, file = "submit_kernel.csv", row.names = F)