...
products_tsnes <- read_csv("tsnes_productname.csv")
...
set.seed(71)
test1 <- Rtsne(as.matrix(prd[, -c(2, 6:21,26:31, 39)]), dims = 2, initial_dims = 50, perplexity = 30,
