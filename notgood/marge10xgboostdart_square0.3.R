...
set.seed(71)
bst.cv <- xgb.cv(params = params, data = X1, nfold = 5, nrounds=cv.nround, early_stopping_rounds= 30)
...
cv.nround <- 1000 #search
set.seed(71)
bst.cv <- xgb.cv(params = params, data = X2, nfold = 5, nrounds=cv.nround, early_stopping_rounds=30)
nround <- bst.cv$best_iteration
...
cv.nround <- 1000 #search
set.seed(71)
bst.cv <- xgb.cv(params = params, data = X3, nfold = 5, nrounds=cv.nround, early_stopping_rounds=30)
nround <- bst.cv$best_iteration
...
cv.nround <- 1000 #search
set.seed(71)
bst.cv <- xgb.cv(params = params, data = X4, nfold = 5, nrounds=cv.nround, early_stopping_rounds=30)
nround <- bst.cv$best_iteration
...
cv.nround <- 1000 #search
set.seed(71)
bst.cv <- xgb.cv(params = params, data = X5, nfold = 5, nrounds=cv.nround, early_stopping_rounds=30)
nround <- bst.cv$best_iteration
...
cv.nround <- 1000 #search
set.seed(71)
bst.cv <- xgb.cv(params = params, data = X6, nfold = 5, nrounds=cv.nround, early_stopping_rounds=30)
nround <- bst.cv$best_iteration
...
cv.nround <- 1000 #search
set.seed(71)
bst.cv <- xgb.cv(params = params, data = X7, nfold = 5, nrounds=cv.nround, early_stopping_rounds=30)
nround <- bst.cv$best_iteration
...
cv.nround <- 1000 #search
set.seed(71)
bst.cv <- xgb.cv(params = params, data = X8, nfold = 5, nrounds=cv.nround, early_stopping_rounds=30)
nround <- bst.cv$best_iteration
...
cv.nround <- 1000 #search
set.seed(71)
bst.cv <- xgb.cv(params = params, data = X9, nfold = 5, nrounds=cv.nround, early_stopping_rounds=30)
nround <- bst.cv$best_iteration
...
write.csv(submission, file = "submit_kernel_dartxgboost_0.22_sq0.3.csv", row.names = F)